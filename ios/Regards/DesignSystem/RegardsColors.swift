...
public enum RegardsPalette {
    ...
    public static let contrastPairs: [Pair] = [
        ...
        .init(name: "Muted on Hair Soft (light)",
              foreground: mutedLight, background: hairSoftLight, minimumRatio: 4.5),
        .init(name: "Muted on Hair Soft (dark)",
              foreground: mutedDark, background: hairSoftDark, minimumRatio: 4.5),
        .init(name: "Ink on Surface (light)",
              foreground: inkLight, background: surfaceLight, minimumRatio: 4.5),
        .init(name: "Ink on Surface (dark)",
              foreground: inkDark, background: surfaceDark, minimumRatio: 4.5),
        .init(name: "Ink on Accent Soft (light)",
              foreground: inkLight, background: accentSoftLight, minimumRatio: 4.5),
        .init(name: "Ink on Accent Soft (dark)",
              foreground: inkDark, background: accentSoftDark, minimumRatio: 4.5),
        .init(name: "Accent Ink on Accent Soft (light)",
              foreground: accentInkLight, background: accentSoftLight, minimumRatio: 4.5),
        .init(name: "Accent Ink on Accent Soft (dark)",
              foreground: accentInkDark, background: accentSoftDark, minimumRatio: 4.5),
        .init(name: "Accent Ink on Background (light)",
              foreground: accentInkLight, background: backgroundLight, minimumRatio: 4.5),
        .init(name: "Accent Ink on Background (dark)",
              foreground: accentInkDark, background: backgroundDark, minimumRatio: 4.5),
        .init(name: "Background on Accent Ink (light)",
              foreground: backgroundLight, background: accentInkLight, minimumRatio: 4.5),
        .init(name: "Background on Accent Ink (dark)",
              foreground: backgroundDark, background: accentInkDark, minimumRatio: 4.5),
